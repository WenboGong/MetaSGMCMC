...
# Run each Sampler
    for i in range(1):
        ...
        ##################### Define parameters #####################
            ...
            # Save Results
            np.savetxt('./Results/NNSGHMC_ep_%s_%s_%s_Acc'%(Param['Epoch'],model_str,timestr),Acc_list_np)
            np.savetxt('./Results/NNSGHMC_ep_%s_%s_%s_NLL'%(Param['Epoch'],model_str,timestr),NLL_list_np)
            write_Dict('./Results/Param_NNSGHMC_ep_%s_%s_%s'%(Param['Epoch'],model_str,timestr), Param)
            ...
            NLL_list_np = np.asarray(NLL_list)
            # Save Results
            np.savetxt('./Results/SGLD_ep_%s_%s_Acc_10' % (Param['Epoch'], timestr), Acc_list_np)
            np.savetxt('./Results/SGLD_ep_%s_%s_NLL_10' % (Param['Epoch'], timestr), NLL_list_np)
            write_Dict('./Results/Param_SGLD_ep_%s_%s_10' % (Param['Epoch'], timestr), Param)
