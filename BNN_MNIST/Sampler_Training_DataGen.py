...
for ep in range(epoch):
    ...
    for ep_se in range(ep_second):
        ...
        Adam_D.step()
    if (ep+1)%10==0:
        torch.save(Q_MLP.state_dict(), './tmp_model_save/Q_state_batch_500_baseline_50D_70G_step_0.007_100ep_broad_0.2_ep%s_DataGen'%(ep+1))
        torch.save(D_MLP.state_dict(), './tmp_model_save/D_state_batch_500_baseline_50D_70G_step_0.007_100ep_broad_0.2_ep%s_DataGen'%(ep+1))
